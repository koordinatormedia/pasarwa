...
const configs = {
	...
	webhook_url: 'http://localhost:88/wablast/filewebhook/webhook.php',
	webhook_group: 'http://localhost:88/wablast/hookgroup.php',
	callback_url: 'http://localhost:88/wablast/callback.php' // webhook url
};
...
async function connect() {
	...
	console.log("Welcome " + conn.user.name + " (" + conn.user.jid + ")");
	io.emit('authenticated', "Welcome " + conn.user.name + " (" + conn.user.jid + ")")
}
